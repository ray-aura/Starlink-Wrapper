...
__export(index_exports, {
  ...
  telemetryResponseSchema: () => telemetryResponseSchema
});
...
var telemetryResponseSchema = import_zod.z.object({
  data: import_zod.z.object({
    data: import_zod.z.object({
      values: import_zod.z.array(import_zod.z.array(import_zod.z.any())),
      columnNamesByDeviceType: import_zod.z.record(import_zod.z.string(), import_zod.z.array(import_zod.z.string()))
    })
  })
});
