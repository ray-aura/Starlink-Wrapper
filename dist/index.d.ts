...
declare class Starlink {
    ...
    getTelemetry(accountNumber: string, batchSize?: number, maxLingerMs?: number): Promise<any>;
    getTelemetryQuery(accountNumber: string, telemetryQuery: TelemetryQuery): Promise<any>;
}
